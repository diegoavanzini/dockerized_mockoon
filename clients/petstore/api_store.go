...
/*
StoreApiService Delete purchase order by identifier.
For valid response try integer IDs with value &lt; 1000. Anything above 1000 or nonintegers will generate API errors.
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param orderId ID of the order that needs to be deleted
*/
func (a *StoreApiService) DeleteOrder(ctx _context.Context, orderId int64) (*_nethttp.Response, error) {
	var (
	...
	localVarPath = strings.Replace(localVarPath, "{"+"orderId"+"}", _neturl.QueryEscape(fmt.Sprintf("%v", orderId)), -1)
 ...
 * @param "Order" (optional.Interface of Order) - 
@return Order
*/
...
func (a *StoreApiService) PlaceOrder(ctx _context.Context, localVarOptionals *PlaceOrderOpts) (Order, *_nethttp.Response, error) {
	var (
